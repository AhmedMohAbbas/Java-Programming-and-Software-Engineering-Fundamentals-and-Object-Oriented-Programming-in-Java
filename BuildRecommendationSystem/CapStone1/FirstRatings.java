...
import java.io.*;
    ...
    private void findNumOfRater(String filename, String RaterID){
    ...
    private void findMaxNumOfRatingsByRater(String filename){
        ArrayList<Rater> raters = loadRaters(filename);
        int max = 0;
        for (Rater currRater: raters){
    ...
    private void findRatingsOfMovie(String filename, String movieID){
        ArrayList<Rater> raters = loadRaters(filename);
        int num = 0;
        for (Rater currRater: raters){
    ...
    private void countRatedMovies(String filename){
        ArrayList<Rater> raters = loadRaters(filename);
    ...
    private void testLoadMovies(String filename){
        ...
        private void testLoadRaters(String filename){
        ArrayList<Rater> raters = loadRaters(filename);
